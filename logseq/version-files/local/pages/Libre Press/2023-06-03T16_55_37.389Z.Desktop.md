...
- # Tasks
	- TODO [#A] Open source cold and hot scientific sheet press for investigating polymer-based material properties
		...
		- TODO Assembly guide incl. schematic
		  SCHEDULED: <2023-05-31 Wed>
		- TODO Delegate prints
		...
		- DONE Software
		- DONE Assemble final device
		- DONE Test, debug, and tune controller
		...
		- TODO Email to Pearce cc Morgan
			- Induction heating experimentation BOM
			- Josh G help
		- DONE Do short write up
